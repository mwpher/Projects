...
typedef NimStringDesc* TY67006[3];
...
N_NOINLINE(void, hello2Init)(void) {
	...
	nimln(1, "hello2.nim");
	write_7703(stdout, ((NimStringDesc*) &TMP120));
	nimln(2, "hello2.nim");
	asgnRefNoCycle((void**) &name_67003, readline_7724(stdin));
	nimln(3, "hello2.nim");
	memset((void*)LOC1, 0, sizeof(LOC1));
	nimln(3, "hello2.nim");
	LOC1[0] = copyString(((NimStringDesc*) &TMP121));
	nimln(3, "hello2.nim");
	LOC1[1] = copyString(name_67003);
	nimln(3, "hello2.nim");
	LOC1[2] = copyString(((NimStringDesc*) &TMP122));
	write_7719(stdout, LOC1, 3);
	popFrame();
}
